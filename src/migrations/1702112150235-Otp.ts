...
export class Otp1702112150235 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TYPE "public"."otp_type_enum" AS ENUM('email_verification', 'password_reset')`);
        await queryRunner.query(`CREATE TABLE "otp" ("user_id" uuid NOT NULL, "code" character varying(6) NOT NULL, "type" "public"."otp_type_enum" NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_258d028d322ea3b856bf9f12f25" PRIMARY KEY ("user_id"))`);
